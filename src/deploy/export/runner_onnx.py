...
def run_onnx_bundle(deploy_config_path: Path, output_directory: Path | None, calibration_images_dir: Path, num_calibration: int = 100):
    try:
        ...
        # INT8
        if run_quantize(deploy_config=deploy_config_path, calibration_images_dir=calibration_images_dir, num_calibration=num_calibration, output_path=output_directory) != 0:
