...
class ExperimentLedger:
    ...
    def get_experiment_state(self, experiment_id: str, fingerprint: str):
        ...
        resp = self._table.get_item(
            Key={"experiment_id": experiment_id, "fingerprint": fingerprint}, ConsistentRead=True
        )
    ...
    def update_checkpoint_pointer(self, experiment_id: str, fingerprint: str, checkpoint_s3_path: str, step: int):
        try:
            self._table.update_item(
                ...
                ExpressionAttributeValues={":path": checkpoint_s3_path, ":step": step},
            )
    ...
    def mark_failure(
        self, experiment_id: str, fingerprint: str, checkpoint_s3_path: str | None, total_steps: int, reason: str
    ):
        try:
...
def get_ec2_instance_id():
    ...
    try:
        ...
        id_req = urllib.request.Request(
            url="http://169.254.169.254/latest/meta-data/instance-id", headers={"X-aws-ec2-metadata-token": resp_token}
        )
