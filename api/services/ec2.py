from ..config import REGION, KEY_PAIR_NAME
import boto3
...
def stop_training(instance_id: str):
    ...
    _ssm_client().send_command(InstanceIds=[instance_id], DocumentName='AWS-RunShellScript', Parameters ={'commands': ['docker stop ml-training']})
