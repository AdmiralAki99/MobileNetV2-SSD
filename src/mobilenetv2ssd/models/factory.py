...
def build_ssd_model(config: dict[str, Any], anchors_per_layer: list[int]):
    ...
    (
        ...
        extra_levels,
        extra_base,
    ) = _extract_information_from_model_config(config)
    ...
    ssd = SSD(
        ...
        number_of_anchors_per_layer=anchors_per_layer,
        input_shape=tuple(input_shape),
        loc_head_configuration=localization_config,
        cls_head_configuration=classification_config,
