...
export const fetchEtlFrames       = (id: number)        => apiFetch(`/api/etl/videos/${id}/frames`)
export const fetchEtlAnnotations  = (id: number)        => apiFetch(`/api/etl/frames/${id}/annotations`)
