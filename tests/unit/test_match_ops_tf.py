...
def test_match_priors():
    ...
    expected_matched_iou = tf.constant([1.0, 0.63999987, 0.0, 1.0, 0.6400002, 0.0], tf.float32)
...
def test_hard_negative_mining():
    ...
    tf.debugging.assert_equal(mined_neg_mask, expected_mask, message="Value mismatch for mined negative mask")
