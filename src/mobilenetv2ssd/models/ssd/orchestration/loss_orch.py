...
def calculate_final_loss(
    ...
    localization_targets: tf.Tensor,
    classification_targets: tf.Tensor,
    ...
    loss_dict = multibox_loss(
        predicted_offsets=predicted_offsets,
        predicted_logits=predicted_logits,
        target_offsets=localization_targets,
        target_labels=classification_targets,
        positive_mask=positive_mask,
        negative_mask=negative_mask,
        localization_weight=loss_config["localization_weights"],
        classification_weight=loss_config["classification_weights"],
        beta=loss_config["smooth_l1_beta"],
        cls_loss_type=loss_config["cls_loss_type"],
        loc_loss_type=loss_config["reg_loss_type"],
        normalize_denom=loss_config["normalization_denom"],
